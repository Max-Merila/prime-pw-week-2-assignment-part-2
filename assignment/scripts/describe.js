...
//then it will display the secret on the console.log
...
let colorTwo = 'blue';
let mix = true;
//fix colorOne should be set to blue and colorTwo should be set to read
//also should have colorTwo set to 'purple' when mix is equal to true
if (mix === true) {
  colorOne = 'purple';
}
*/
...
let temp = 40;
const time = 4;
//Fix || should be && so it reads temp is higher and the time is greater or equal to 4. Not Or time is greater or equal to 4
if (temp > 39 || time >= 4) {
...
let age = 21;
const minAge = 21;
//Fix the if statement should read if(age >= minAge) {
console.log('enter');
}
if(minAge <= age) {
